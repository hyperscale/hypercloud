...
require (
	...
	github.com/docker/docker v24.0.0-rc.2.0.20230531091251-8d67d0c1a8d2+incompatible
	...
	github.com/moby/swarmkit/v2 v2.0.0-20230607145746-36334ed18760 // indirect
