...
import (
	...
	"github.com/hyperscale/hypercloud/pkg/hypercloud/docker/compose"
...
func (c *installerController) postInstallerHandler(w http.ResponseWriter, r *http.Request) {
	...
	go func() {
		namespace := convert.NewNamespace("hypercloud")
		...
		file, err := os.OpenFile("./var/lib/hypercloud/secrets/registry.htpasswd", os.O_CREATE|os.O_WRONLY|os.O_TRUNC, 0644)
		if err != nil {
